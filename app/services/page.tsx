                  ...
                  <Card>
                    <div className="flex items-start gap-6 mb-6">
                      ...
                      <div className="flex-1">
                        <h2 className="text-3xl font-bold text-text-main mb-3">{service.title} - Performance Marketing Service</h2>
                        <p className="text-lg text-text-muted mb-6">{service.tagline}</p>
                        <div className="space-y-4">
                          <div>
                            <h3 className="text-lg font-semibold text-text-main mb-3">What's included:</h3>
      ...
      <section className="py-20 bg-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <Card>
              <h3 className="text-xl font-bold text-text-main mb-3">Funnels & Landing Pages</h3>
            ...
            <Card>
              <h3 className="text-xl font-bold text-text-main mb-3">Creative Strategy</h3>
              <p className="text-text-muted mb-4">
